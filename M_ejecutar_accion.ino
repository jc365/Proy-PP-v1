void ejecutar_accion( int srv, int p1, int p2, int p3) {  
  ...
  switch(srv) {
    case 10:
      ...
      msg = "#1:1:0:0:0/";
      Zig.print(msg);                       // peticion de lectura temp/hume/luz exterior a Remoto1
      break;
    case 11:
